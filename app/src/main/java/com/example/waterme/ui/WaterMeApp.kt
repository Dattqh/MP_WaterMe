...
import com.example.waterme.TWENTY_SECONDS
...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.ten_seconds, TEN_SECONDS, TimeUnit.SECONDS, plantName),
        Reminder(R.string.twenty_seconds, TWENTY_SECONDS, TimeUnit.SECONDS, plantName),
